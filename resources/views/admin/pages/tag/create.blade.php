            ...
            <div id="content" class="ui-content">
                <div class="ui-content-body">
                    ...
                    <div class="ui-container">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <h1 class="page-title"> Add New Tag</h1>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="sign-in-wrapper">
                                <div class="singn-admin-container">
                                    ...
                                    <div class="text-center">
                                        ...
                                        {!! Form::open(['url'=>action('TagsController@store'), 'method'=>'post']) !!}
                                        
                                        
                                        <div class="form-group">
                                            <p class="help-block">Tag Name</p>
                                            {!! Form::text('name', old('name'), ['class'=>'form-control','placeholder'=>'Tag name','required']) !!}
                                        </div>
