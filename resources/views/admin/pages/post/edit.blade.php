                                            ...
                                            <div class="col-md-10 col-md-offset-1">
                                                  ...
                                                  {!! Form::model($post, [
                                                            ...
                                                            <div class="form-group">
                                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                  <div class="fileinput-new thumbnail" style="width: 300px; height: 300px;">
                                                                    <img src="{{ ($post->image) ? '/public/front/img/'.$post->image : 'http://placehold.it/200x150&text=No+Image' }}" alt="...">
                                                                  </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                            ...
                                                            {!! Form::select('category_id[]', \App\Category::pluck('name','id'),$post->categories()->pluck('categories.id')->toArray(), ['class'=>'form-control test','required','multiple'=>'multiple']) !!}
                                                    </div>
                                                    
                                                    <div class="col-sm-12">
                                                            {!! Form::label('Select Tsgs') !!}
                                                            {!! Form::select('tag_id[]', \App\Tag::pluck('name','id'),$post->tags()->pluck('tags.id')->toArray(), ['class'=>'form-control test','required','multiple'=>'multiple']) !!}
